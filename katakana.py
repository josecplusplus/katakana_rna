...
from training_data import train_images
from training_data import test_images
...
def test(weights, testing_data):
    ...
    for data in testing_data:
        true_data = data[0]
        noisy_data = convert_zero(data[1])
...
def convert_bipolar(a):
    ca = [-1 if x==0 else 1 for x in a]
    return ca
